...
public class MailController {
	...
	@RequestMapping("/send")
	public Result send(@RequestParam String from, @RequestParam String to, @RequestParam String subject, @RequestParam String content) throws Exception {
	...
	public String template(@RequestParam String title, @RequestParam String content) throws Exception {
